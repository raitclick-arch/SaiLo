document.addEventListener("DOMContentLoaded", () => {
    ...
    function bindGameCardEvents() {
        ...
        // 0-Margin, Edge-to-Edge Full Canvas Launch Logic
        if(launchBtn) {
            launchBtn.addEventListener("click", () => {
                ...
                centerHub.innerHTML = `
                    <div style="position: relative; width: 100%; height: 100%; margin: 0; padding: 0; background: #000; overflow: hidden; display: flex;">
                        ...
                        <!-- Full Coverage Game Screen (Top & Corners perfectly glued) -->
                        <div style="width: 100%; height: 100%; margin: 0; padding: 0; border: none; display: flex;">
    ...
    // Drawer-based Member Action Panel
